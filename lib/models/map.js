Metamaps.Map = Backbone.Model.extend({
    ...
    fetchContained: function () {
        ...
        var start = function (data) {
            that.set('mappers', new Metamaps.MapperCollection(data.mappers));
            that.set('topics', new Metamaps.TopicCollection(data.topics));
            that.set('synapses', new Metamaps.SynapseCollection(data.synapses));
            that.set('mappings', new Metamaps.MappingCollection(data.mappings));
        };
