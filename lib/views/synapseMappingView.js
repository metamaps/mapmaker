Metamaps.SynapseMappingView = (function($, famous) {
	...
	var Handlers = {
		mousedown: function(event) {
			...
			$(document).trigger(Metamaps.SynapseMappingView.events.mousedown);
		},
		mouseup: function(event) {
			this.mouseIsDown = false;

			$(document).trigger(Metamaps.SynapseMappingView.events.mouseup);
		}
	};
 ...
 * @static
 */
Metamaps.SynapseMappingView.events = {
	mousedown: "Metamaps:SynapseMappingView:mousedown",
	mouseup: "Metamaps:SynapseMappingView:mouseup"
};
