Metamaps.TopicMappingView = (function($, famous) {
	...
	var Handlers = {
		...
		mouseup: function(event) {
			...
			$(document).trigger(Metamaps.TopicMappingView.events.mouseup, [this]);
			...
			if (now - storedTime < this.view.config.DOUBLE_CLICK_TOLERANCE) {
				$(document).trigger(Metamaps.TopicMappingView.events.doubleClick, [this]);
			}
		},
	...
	var Private = {
		cancelClick: function() {
			...
			$(document).trigger(Metamaps.TopicMappingView.events.dragEnd);
		},
...
Metamaps.TopicMappingView.events = {
	...
	doubleClick: "Metamaps:TopicMappingView:doubleClick",
	dragEnd: "Metamaps:TopicMappingView:dragEnd",
};
