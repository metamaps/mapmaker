...
Mapmaker.TopicCardView = (function($) {
  ...
  var Private = {
    ...
    var
      obj = Private.buildObjectForTemplate(this.model);
...
Mapmaker.TopicCard = {
    ...
    init: function () {
        ...
        Mapmaker.TopicCard.generateShowcardHTML = Hogan.compile($('#topicCardTemplate').html());
    ...
    handleInvalidLink: function() {
        ...
        self.removeLink();
        Mapmaker.GlobalUI.notifyUser("Invalid link");
    },
